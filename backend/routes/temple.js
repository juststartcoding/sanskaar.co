...
router.get("/", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching temples", error: error.message });
  }
});
...
router.get("/:id", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching temple", error: error.message });
  }
});
...
router.get("/search", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error searching temples", error: error.message });
  }
});
...
router.post("/nearby", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error finding nearby temples", error: error.message });
  }
});
...
router.post("/", async (req, res) => {
  try {
    ...
    res
      .status(400)
      .json({ message: "Error creating temple", error: error.message });
  }
});
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error deleting temple", error: error.message });
  }
});
